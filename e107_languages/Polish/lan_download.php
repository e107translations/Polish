...
+--------------------------------------------------------------------+
   ...
   * Polish language file - lan_download.php                     	 *
	* $Date: 2019/08/14                                              *
...
define("LAN_dl_79", "Proszę poczekać kilka chwil przed [ponownym pobraniem pliku].");
define("LAN_dl_80", "Proszę włączyć obsługę ciasteczek i [spróbować ponownie].");
define("LAN_dl_81", "Wymagana obsługa ciasteczek");
define("LAN_dl_82", "Proszę czekać");

//0.7.25

define("LAN_dl_83", "Pobieranie rozpocznie się za chwilę...");
define("LAN_dl_84", "Proszę [kliknąć tutaj], jeśli pobieranie nie rozpocznie się za kilka sekund.");
