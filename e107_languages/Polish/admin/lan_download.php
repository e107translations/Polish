...
+--------------------------------------------------------------------+
   ...
   * Polish language file - admin/lan_download.php                   *
	* $Date: 2019/08/14                                              *
...
define("DOWLAN_140", "Załaduj obrazki do lokalnego folderu ". e_FILE ."downloadimages, aby wyświetlić je tutaj, lub wpisz pełny adres do pliku umieszczonego na zewnętrznym serwerze");
...
define("DOWLAN_150", "Wiadomość e-mail do administratora, gdy zgłoszono uszkodzony plik"); // Email admin when broken download reported
...
define("DOWLAN_160", "Zapobiegaj jednoczesnemu pobieraniu plików przez poszczególnych użytkowników");
define("DOWLAN_161", "Używaj strony przestoju, aby opóźnić pobieranie plików");

define("DOWLAN_162", "Pobierane");
define("DOWLAN_163", "Użytkownik");
define("DOWLAN_164", "IP");
define("DOWLAN_165", "Data / czas");
define("DOWLAN_166", "Powróć do strony głównej 'Plików do pobrania'");

define("DOWLAN_199", "Uwaga: Po zmianie rozmiaru pliku statystyki pobieranych plików mogą nie odzwierciedlać ich całkowitej historii!");
define("DOWLAN_200", "Numer");
define("DOWLAN_201", "Log zmian");
define("DOWLAN_202", "Szczegółowy log zmian");
