...
define("ADSTAT_L35", "Kompaktowy widok statystyk przeglądarek");
define('ADSTAT_L38', "Musisz ustawić katalog e107_plugins/log/logs z możliwością do zapisu");   // Constant compatible with 0.8
